        ...
        <Row>
          ...
          <Col lg={4}>
            <Widget
              ...
              title={<h5> 지역별
                      <span className="fw-semi-bold">&nbsp;통계</span></h5>} settings refresh close
            >
              <p>범위: <strong>전국</strong></p>
              <p>
                <span className="circle bg-default text-white"><i className="fa fa-map-marker" /></span> &nbsp;
                146 개의 신규매물, 총 2759 개의 매물
              </p>
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">실거래가 대비 평균 매물시세 (1개월)</h6>
                  <p className="description deemphasize mb-xs text-white">2022-12-01 ~ 2023-01-01</p>
                  <Progress color="primary" value="15" className="bg-subtle-blue progress-xs" />
                </div>
                <div className="col-md-3 col-12 text-center">
                  <span className="status rounded rounded-lg bg-default text-light">
                    <small><AnimateNumber value={-15} />%</small>
                  </span>
                </div>
              </div>
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">실거래가 대비 평균 매물시세 (1년)</h6>
                  <p className="description deemphasize mb-xs text-white">2022-01-01 ~ 2023-01-01</p>
              ...
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">실제 거래량 (1년)</h6>
                  <p className="description deemphasize mb-xs text-white">2022-01-01 ~ 2023-01-01</p>
